    ...
    update(axes, camera) {
        ...
        if (this.material.userData.shader) {
            ...
            this.material.userData.shader.uniforms.inOpacity.value =
                THREE.MathUtils.lerp(
                    this.material.userData.shader.uniforms.inOpacity.value,
                    axes.opacity * this.axes.inOpacity,
                    0.01
                )
            this.material.userData.shader.uniforms.minOpacity.value =
                this.axes.opacity
            ...
            this.material.userData.shader.uniforms.colLight.value =
                this.colLight
        ...
        const visibleArea = this.calculateVisibleAreaAtDistance(
            distanceToCamera,
            camera
        )
        ...
        let tangentialForce = new THREE.Vector3()
            ...
            .normalize()
            .multiplyScalar(orbitSpeed) // Adjust the tangential force magnitude as needed
